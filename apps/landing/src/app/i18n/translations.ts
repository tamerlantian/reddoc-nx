    ...
    plans_billing: [
      {
        ...
        users: '1',
        cap: '$10.000.000',
        perks: ['Documentos ilimitados', 'Soporte técnico estándar', 'Facturación electrónica'],
      },
      {
        id: 'crecimiento',
        name: 'Crecimiento',
        ...
        users: '2',
        cap: '$50.000.000',
        perks: ['Documentos ilimitados', 'Soporte técnico estándar', 'Reportes avanzados'],
        highlight: true,
      },
      {
        id: 'expansion',
        ...
        users: '3',
        cap: '$200.000.000',
        perks: ['Documentos ilimitados', 'Soporte técnico premium', 'Roles y permisos'],
      },
      {
        id: 'exito',
        name: 'Éxito',
        ...
        users: '8',
        cap: '$500.000.000',
        perks: ['Documentos ilimitados', 'Soporte especializado', 'Onboarding dedicado'],
      },
    ],
    plans_erp: [
      {
        ...
        users: '1',
        cap: '$10.000.000',
        perks: ['Compras y ventas', 'Tesorería y cartera', 'Documentos ilimitados'],
      },
      {
        id: 'crecimiento-erp',
        ...
        users: '2',
        cap: '$50.000.000',
        perks: ['Compras, ventas, tesorería', 'POS+ incluido', 'Contabilidad incluida'],
        highlight: true,
      },
      {
        id: 'expansion-erp',
        ...
        users: '3',
        cap: '$200.000.000',
        perks: ['Todos los módulos', 'Reportes avanzados', 'Soporte premium'],
      },
      {
        id: 'exito-erp',
        name: 'Éxito ERP',
        ...
        users: '8',
        cap: '$500.000.000',
        perks: ['Todos los módulos + API', 'Tablero analítico', 'Soporte especializado'],
      },
    ],
    ...
    plans_billing: [
      {
        ...
        users: '1',
        cap: '$10,000,000',
        perks: ['Unlimited documents', 'Standard support', 'E-invoicing'],
      },
      {
        id: 'crecimiento',
        name: 'Growth',
        ...
        users: '2',
        cap: '$50,000,000',
        perks: ['Unlimited documents', 'Standard support', 'Advanced reports'],
        highlight: true,
      },
      {
        id: 'expansion',
        ...
        users: '3',
        cap: '$200,000,000',
        perks: ['Unlimited documents', 'Premium support', 'Roles and permissions'],
      },
      {
        id: 'exito',
        name: 'Success',
        ...
        users: '8',
        cap: '$500,000,000',
        perks: ['Unlimited documents', 'Specialized support', 'Dedicated onboarding'],
      },
    ],
    plans_erp: [
      {
        ...
        users: '1',
        cap: '$10,000,000',
        perks: ['Purchases & sales', 'Treasury & A/R', 'Unlimited documents'],
      },
      {
        id: 'crecimiento-erp',
        name: 'Growth ERP',
        ...
        users: '2',
        cap: '$50,000,000',
        perks: ['Purchases, sales, treasury', 'POS+ included', 'Accounting included'],
        highlight: true,
      },
      {
        id: 'expansion-erp',
        ...
        users: '3',
        cap: '$200,000,000',
        perks: ['All modules', 'Advanced reports', 'Premium support'],
      },
      {
        id: 'exito-erp',
        name: 'Success ERP',
        ...
        users: '8',
        cap: '$500,000,000',
        perks: ['All modules + API', 'Analytics dashboard', 'Specialized support'],
      },
    ],
