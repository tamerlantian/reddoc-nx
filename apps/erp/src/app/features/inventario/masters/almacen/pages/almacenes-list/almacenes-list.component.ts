...
import {
  ALMACENES_COLUMNS,
  ALMACENES_EXPORT_URL,
  ALMACENES_FILTER_FIELDS,
  ALMACENES_FILTERS_STORAGE_KEY,
  ALMACENES_PRIMARY_ACTION,
...
export class AlmacenesListComponent {
  ...
  protected readonly selectedRows = signal<readonly Almacen[]>([]);
  protected readonly searchValue = signal('');
  protected readonly activeFilters = signal<readonly FilterCondition[]>(
    this.filterStorage.read(ALMACENES_FILTERS_STORAGE_KEY),
  );
  ...
  protected readonly rowActions = ALMACENES_ROW_ACTIONS;
  protected readonly primaryAction = ALMACENES_PRIMARY_ACTION;
  protected readonly trailingActions = ALMACENES_TRAILING_ACTIONS;
  ...
  protected onFiltersApply(filters: readonly FilterCondition[]): void {
    ...
    this.filterStorage.write(ALMACENES_FILTERS_STORAGE_KEY, filters);
    this.currentPage.set(0);
    this.loadList();
  }
  ...
  protected clearFilters(): void {
    ...
    this.filterStorage.clear(ALMACENES_FILTERS_STORAGE_KEY);
    this.currentPage.set(0);
    this.loadList();
  }

  protected onSelectionChange(rows: unknown[]): void {
    this.selectedRows.set(rows as Almacen[]);
  }
  ...
  private loadList(): void {
    const search = quickSearchCondition(ALMACENES_QUICK_SEARCH_FIELD, this.searchValue());
