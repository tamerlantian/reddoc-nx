...
export const en: AppDict = {
  ...
  documentActions: {
    ...
    contabilidad: {
      title: 'Accounting',
      subtitle: 'Accounting entries generated by this document.',
      contabilizar: 'Post',
      descontabilizar: 'Unpost',
      descuadre: 'The accounting entry is unbalanced.',
      totales: { debitos: 'Debits', creditos: 'Credits' },
      empty: {
        title: 'No accounting entries',
        desc: 'The document is not posted yet or generated no entries.',
      },
      toasts: {
        loadError: {
          title: 'Could not load accounting',
          desc: 'An error occurred while fetching the document entries.',
        },
        contabilizarSuccess: {
          title: 'Document posted',
          desc: 'The document was posted successfully.',
        },
        contabilizarError: {
          title: 'Could not post',
          desc: 'An error occurred while posting the document.',
        },
        descontabilizarSuccess: {
          title: 'Document unposted',
          desc: 'The document was unposted successfully.',
        },
        descontabilizarError: {
          title: 'Could not unpost',
          desc: 'An error occurred while unposting the document.',
        },
      },
    },
    estados: {
